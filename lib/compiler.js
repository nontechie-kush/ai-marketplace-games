...
<body>
  <header>
    ...
    <div class="hud">
      ...
      <span>⚙️ Spawning: <b id="hud-spawn">1/2s</b></span>
  ...
  <div class="wrap">
      ...
      <div style="position:relative">
        ...
        <div id="overlay" class="overlay">
          <div class="card">
            ...
            <p class="small">Prick bubbles by clicking/tapping. Every 2s the spawn amount doubles. Hit 100 bubbles on screen and it's game over.</p>
    ...
    <div class="panel">
      ...
      <div class="muted">Click or tap bubbles to pop them. Spawns double every 2 seconds. Survive as long as possible. Press <b>${escapeHtml(pauseKey)}</b> to pause.</div>
...
(() => {
  ...
  function update(dt){
    ...
    const windowDur = cfg.windowMs; // e.g., 2000ms
    const currentIndex = Math.floor(sinceStart / windowDur); // 0,1,2...
    const targetInThisWindow = Math.pow(2, currentIndex); // 1,2,4,8...
    hudSpawn.textContent = targetInThisWindow + '/2s';

    // catch-up logic: ensure total spawns in the current 2s window reaches target
